...
var romeow = {
    name: 'Romeow',
    age: '3',
    imageUrl: './public/catImgs/romeowImg.jpg',
    gender: 'Male',
...
database.insertOne(Cat, romeow, null);

var milky = {
    name: 'Milky',
    age: '4',
    imageUrl: './public/catImgs/milkyImg.jpg',
    gender: 'Female',
...
database.insertOne(Cat, milky, null);

var icecube = {
    name: 'Ice Cube',
    age: '5',
    imageUrl: './public/catImgs/icecubeImg.jpg',
    gender: 'Male',
...
database.insertOne(Cat, icecube, null);

var levy = {
    name: 'Levy',
    age: '3',
    imageUrl: './public/catImgs/levyImg.jpg',
    gender: 'Male',
...
database.insertOne(Cat, levy, null);

var animo = {
    name: 'Animo',
    age: '7',
    imageUrl: './public/catImgs/animoImg.jpg',
    gender: 'Female',
...
database.insertOne(Cat, animo, null);

//Laguna Campus Cats
var charlie = {
    name: 'Charlie',
    age: '2',
    imageUrl: './public/catImgs/charlieImg.jpg',
    gender: 'Male',
...
database.insertOne(Cat, charlie, null);

var flash = {
    name: 'Flash',
    age: '1',
    imageUrl: './public/catImgs/flashImg.jpg',
    gender: 'Male',
...
database.insertOne(Cat, flash, null);

var mao = {
    name: 'Mao',
    age: '3',
    imageUrl: './public/catImgs/maoImg.jpg',
    gender: 'Male',
...
database.insertOne(Cat, mao, null);

var artha = {
    name: 'Artha',
    age: '2',
    imageUrl: './public/catImgs/arthaImg.jpg',
    gender: 'Female',
...
database.insertOne(Cat, artha, null);

var land = {
    name: 'Land',
    age: '1',
    imageUrl: './public/catImgs/landImg.jpg',
    gender: 'Female',
...
database.insertOne(Cat, land, null);